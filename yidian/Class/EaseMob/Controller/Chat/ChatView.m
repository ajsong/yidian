...
@interface ChatView ()<UIAlertViewDelegate,EMClientDelegate,EMChatManagerDelegate>
{
...
- (void)viewDidLoad {
	...
	[self setShowRefreshHeader:YES beginRefresh:NO];
	self.delegate = self;
...
{
	//单聊
	if (self.conversation.type == EMConversationTypeChat && _showClearButton) {
   ...
   didLongPressRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	if (![object isKindOfClass:[NSString class]]) {
		...
		if ([cell isKindOfClass:NSClassFromString(@"EaseGoodsMessageCell")]) return NO;
