...
@implementation EaseAnnotationView
...
-(void)initUI{
    ...
    self.bgImgView.image = [[UIImage imageNamed:@"chat_location_annotation_bg"] stretchableImageWithLeftCapWidth:28 topCapHeight:16];
...
-(void)createBtn:(float)width{
	NSString *imageName = [NSString stringWithFormat:@"chat_location_annotation_position_%@", self.colorName];
	NSString *highlightedImageName = [NSString stringWithFormat:@"chat_location_annotation_position_%@_press", self.colorName];
	...
	[naviBtn setImage:[UIImage imageNamed:imageName] forState:UIControlStateNormal];
	[naviBtn setImage:[UIImage imageNamed:highlightedImageName] forState:UIControlStateHighlighted];
...
-(void)naviMap:(id)sender{
    [delegate EaseAnnotationViewNaviClick];
}
...
- (CGSize)getSizeOfString:(NSString *)string maxWidth:(float)width withFontSize:(int)fontSize {
	...
	CGRect rect = [string boundingRectWithSize:CGSizeMake(width, MAXFLOAT) options:options attributes:attributes context:NULL];
...
-(void)addConner:(CGRect)rect{
    ...
    connerView.image = [UIImage imageNamed:@"chat_location_annotation_jt"];
...
-(void)addCenter:(CGRect)anFrame{
    ...
    locImg.image = [UIImage imageNamed:@"chat_location_annotation"];
