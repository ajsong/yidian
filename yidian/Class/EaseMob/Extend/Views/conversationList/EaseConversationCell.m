...
+ (void)initialize
{
    ...
    cell.detailLabelColor = [UIColor colorWithRed:119/255.f green:119/255.f blue:119/255.f alpha:1.f];
    cell.detailLabelFont = [UIFont systemFontOfSize:12];
    cell.timeLabelColor = [UIColor colorWithRed:204/255.f green:204/255.f blue:204/255.f alpha:1.f];
...
- (void)_setupSubview
{
	...
	_avatarView.imageView.clipsToBounds = YES;
...
- (void)setModel:(id<IConversationModel>)model
{
    ...
    if (self.showAvatar) {
        if ([_model.avatarURLPath length] > 0){
            [self.avatarView.imageView em_setImageWithURL:[NSURL URLWithString:_model.avatarURLPath] placeholderImage:_model.avatarImage];
        } else {
