...
- (id)initWithString:(NSString *)string {
	if (self = [super init]) {
		...
		NSDictionary * jsonQuery = [NSJSONSerialization JSONObjectWithData:data options:NSJSONReadingAllowFragments error:nil];
		if (!jsonQuery) {
...
+ (AlipayResult *)itemWithDictory:(NSDictionary *)dict{
    AlipayResult *temp = [[AlipayResult alloc] init];
    temp.statusCode = [dict[@"resultStatus"] intValue];
