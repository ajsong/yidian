...
@implementation GestureRecognizerImageView
...
-(void)touchesMoved:(NSSet *)touches withEvent:(UIEvent *)event{
	...
	if (_delegate && [_delegate respondsToSelector:@selector(dragGestureRecognizerImageViewWithMoveInMaxArea:)]) {
		UIEdgeInsets edgeInsets = [_delegate dragGestureRecognizerImageViewWithMoveInMaxArea:self];
	...
	if (_delegate && [_delegate respondsToSelector:@selector(dragGestureRecognizerImageViewWithMove:)]) {
		[_delegate dragGestureRecognizerImageViewWithMove:self];
	}
}
