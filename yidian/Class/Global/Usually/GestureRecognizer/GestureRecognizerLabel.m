...
@implementation GestureRecognizerLabel
...
-(void)touchesMoved:(NSSet *)touches withEvent:(UIEvent *)event{
	...
	if (_delegate && [_delegate respondsToSelector:@selector(dragGestureRecognizerLabelWithMoveInMaxArea:)]) {
		UIEdgeInsets edgeInsets = [_delegate dragGestureRecognizerLabelWithMoveInMaxArea:self];
	...
	if (_delegate && [_delegate respondsToSelector:@selector(dragGestureRecognizerLabelWithMove:)]) {
		[_delegate dragGestureRecognizerLabelWithMove:self];
	}
}
