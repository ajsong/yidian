...
@interface productGoods ()<UITableViewDataSource,UITableViewDelegate>{
	NSMutableArray *_ms;
	UITableView *_table;
	NSInteger _offset;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
	...
	NSInteger section = indexPath.section;
	NSInteger row = indexPath.row;
	[_delegate GlobalExecuteWithData:_ms[row] caller:nil];
